...
(() => {
  ...
  var Collection = class {
    ...
    fetch() {
      axios_default.get(this.url).then((res) => {
  ...
  var User = class _User extends Model {
    ...
    static buildCollection() {
      return new Collection(url, (json) => _User.build(json));
    }
    setRandomAge() {
  ...
  var john = User.build({ id: "12", name: "John", age: 20 });
  var userShow = new UserShow(rootElement, john);
  var userForm = new UserForm(rootElement, john);
  userShow.render();
})();
